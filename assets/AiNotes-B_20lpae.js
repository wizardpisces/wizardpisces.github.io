const x={},F=`<h1 id="LoRA(low-rank-adapter) and ControlNet"><a href="#LoRA(low-rank-adapter) and ControlNet"></a>LoRA(low-rank-adapter) and ControlNet</h1>
<ul>
<li>LoRA
